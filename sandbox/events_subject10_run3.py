...
fname = '/media/harddrive/2013_meg_ambiguity/python/data/ambiguity/MEG/subject10_cs/run_03_filt-0-30_sss_raw.fif'
bhv_fname = '/media/harddrive/2013_meg_ambiguity/python/data/ambiguity/behavior/cs_behaviorMEG.mat'

mat_events = get_events(bhv_fname)
mat_eventsM = get_events(bhv_fname, 'motor_lock')
mat_eventsS = get_events(bhv_fname, 'stim_locl')
all_events = extract_events(fname, offset_to_zero_M=True, offset_to_zero_S=False)
...
plt.plot(_data[-4:,350000:380000].transpose())
plt.show()

diff = _data[-4:-2,1:] - _data[-4:-2,0:-1]
