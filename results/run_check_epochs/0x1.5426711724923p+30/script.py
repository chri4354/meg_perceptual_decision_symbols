...
for subject in subjects:
    ...
    mat = np.array(events['motor_RT'].astype(list))
    ...
    fiff = list()
    for ii in m:
        fiff.append(epochs.events[ii, 0] - epochs.events[ii-1, 0])
    ...
    if len(mat) > len(fiff):
        ...
        mat = mat[sel]
        print('need to remove motor {}'.format(rm))
